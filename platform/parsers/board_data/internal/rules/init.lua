...
append(Rules, require("platform.parsers.board_data.internal.rules.token_explicit"))
append(Rules, require("platform.parsers.board_data.internal.rules.chunk_explicit"))
append(Rules, require("platform.parsers.board_data.internal.rules.token_implicit"))
append(Rules, require("platform.parsers.board_data.internal.rules.chunk_implicit"))
