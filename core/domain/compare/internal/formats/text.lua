-- core/domain/compare/internal/formats/text.lua
--
-- Formatter for ComparisonModel.
-- Returns lines; does not print. No IO.

local Layout = require("core.domain.compare.internal.formats.layout")
...
--- @return table result { kind="text", lines=string[] }
function M.format(model, opts)
    opts = opts or {}
    ...
    for _, row in ipairs(model.rows or {}) do
        ...
        for _, src in ipairs(sources) do
            local offer = (row.offers or {})[src] or {}
