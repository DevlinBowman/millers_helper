...
append(Rules, require("parsers.board_data.rules.token_explicit"))
append(Rules, require("parsers.board_data.rules.chunk_explicit"))
append(Rules, require("parsers.board_data.rules.token_implicit"))
append(Rules, require("parsers.board_data.rules.chunk_implicit"))
